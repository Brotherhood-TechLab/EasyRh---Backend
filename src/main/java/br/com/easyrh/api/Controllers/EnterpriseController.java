...
public class EnterpriseController
{
  ...
  @Operation(summary = "Register a new enterprise", description = "Register a new enterprise", tags = {
      "Enterprise" }, responses = {
          @ApiResponse(responseCode = "200", description = "Successful operation", content = {
              @Content(mediaType = "application/json", schema = @Schema(implementation = ResponseEnterpriseRegisterJson.class))
          }),
          @ApiResponse(responseCode = "400", description = "Bad request", content = @Content),
          @ApiResponse(responseCode = "403", description = "Forbidden", content = @Content),
          @ApiResponse(responseCode = "500", description = "Internal server error", content = @Content)
      })
  public ResponseEntity<ResponseEnterpriseRegisterJson> Register(
      @RequestBody @Validated RequestEnterpriseRegisterJson request) {
