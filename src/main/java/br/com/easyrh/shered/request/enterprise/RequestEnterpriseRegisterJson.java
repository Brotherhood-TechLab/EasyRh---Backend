...
public class RequestEnterpriseRegisterJson implements Serializable  
{
    ...
    public RequestEnterpriseRegisterJson(String idNumber, RequestAddressRegisterJson address, String cnpj
    , String email, String logoImage, String name, String phoneNumber) {
